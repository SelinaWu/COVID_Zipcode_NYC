## Data List
- covid-19 cases from 4/1 to 5/14
- mobility data: citibike in 2020 and subway ridership
- census data can be queried using code in BigQuery on Google Cloud: <br>
```SQL
SELECT * FROM `bigquery-public-data.census_bureau_acs.zip_codes_2018_5yr`
where geo_id IN ('10453', '10457', '10460', '10458', '10467', '10468', '10451', 
